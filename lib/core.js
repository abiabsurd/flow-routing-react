...
AccountsTemplates.configureRoute = function(route, options) {
  ...
  if (Package['gadicc:blaze-react-component']) {
    ...
    layoutRegions[contentRegion] = blazeToReact(template)({});
  } else {
    throw new Error("This package requires that your project includes the gadicc:blaze-react-component package.");
  }
  ...
  //   // Ensure that we have the required packages to render Blaze templates
  //   //
  //   // For now we need to render the main template using gadicc:blaze-react-component

  //   var React = require('react');
  //   var ReactMounter = require('react-mounter');

  //   if (Package['gadicc:blaze-react-component']) {
  //     var BlazeReactComponent = Package['gadicc:blaze-react-component'].Blaze;
  //   } else {
  //     throw new Error("This package requires that your project includes the gadicc:blaze-react-component package.");
  //   }

  //   layoutRegions[contentRegion] = React.createElement(BlazeReactComponent, { template: template });
  // }
  ...
  //     // We need to render using ReactMounter and BlazeReactComponent

  //     ReactMounter.mount(layoutTemplate, layoutRegions);
  //   } else {
